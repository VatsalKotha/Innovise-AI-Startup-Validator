...
import { oklchToHexMap } from '@/utils/color-conversions'; // Adjust path as needed
import { PDFDownloadLink } from '@react-pdf/renderer';
import MyDocument from "./PdfDocument"; // We'll create this component separately
        ...
        <div className="flex justify-between items-center">
          ...
          {data && (
            <PDFDownloadLink
              ...
              fileName="idea-validation-report.pdf"
            >
              {({ loading }) => (
                <Button className="bg-[#F3F0E7] text-black hover:bg-accent shadow rounded-2xl" disabled={loading}>
